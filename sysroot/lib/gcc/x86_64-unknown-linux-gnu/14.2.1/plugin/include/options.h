...
enum opt_code
{
  ...
  OPT_mbmi = 2019,                           /* -mbmi */
  OPT_mbmi2 = 2020,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 2021,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 2022,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 2023,                    /* -mcet-switch */
  OPT_mcld = 2024,                           /* -mcld */
  OPT_mcldemote = 2025,                      /* -mcldemote */
  OPT_mclflushopt = 2026,                    /* -mclflushopt */
  OPT_mclwb = 2027,                          /* -mclwb */
  OPT_mclzero = 2028,                        /* -mclzero */
  OPT_mcmodel_ = 2029,                       /* -mcmodel= */
  OPT_mcmpccxadd = 2030,                     /* -mcmpccxadd */
  /* OPT_mcpu_ = 2031, */                    /* -mcpu= */
  OPT_mcrc32 = 2032,                         /* -mcrc32 */
  OPT_mcx16 = 2033,                          /* -mcx16 */
  OPT_mdaz_ftz = 2034,                       /* -mdaz-ftz */
  OPT_mdirect_extern_access = 2035,          /* -mdirect-extern-access */
  OPT_mdispatch_scheduler = 2036,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 2037,            /* -mdump-tune-features */
  OPT_menqcmd = 2038,                        /* -menqcmd */
  OPT_mevex512 = 2039,                       /* -mevex512 */
  OPT_mf16c = 2040,                          /* -mf16c */
  OPT_mfancy_math_387 = 2041,                /* -mfancy-math-387 */
  OPT_mfentry = 2042,                        /* -mfentry */
  OPT_mfentry_name_ = 2043,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 2044,               /* -mfentry-section= */
  OPT_mfma = 2045,                           /* -mfma */
  OPT_mfma4 = 2046,                          /* -mfma4 */
  OPT_mforce_drap = 2047,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 2048,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 2049,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 2050,                       /* -mfpmath= */
  OPT_mfsgsbase = 2051,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 2052,              /* -mfunction-return= */
  /* OPT_mfused_madd = 2053, */              /* -mfused-madd */
  OPT_mfxsr = 2054,                          /* -mfxsr */
  /* OPT_mgather = 2055, */                  /* -mgather */
  OPT_mgeneral_regs_only = 2056,             /* -mgeneral-regs-only */
  OPT_mgfni = 2057,                          /* -mgfni */
  OPT_mglibc = 2058,                         /* -mglibc */
  OPT_mhard_float = 2059,                    /* -mhard-float */
  OPT_mharden_sls_ = 2060,                   /* -mharden-sls= */
  OPT_mhle = 2061,                           /* -mhle */
  OPT_mhreset = 2062,                        /* -mhreset */
  OPT_miamcu = 2063,                         /* -miamcu */
  OPT_mieee_fp = 2064,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 2065,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 2066,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 2067,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 2068,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 2069,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 2070,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 2071,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 2072, */            /* -mintel-syntax */
  OPT_mkl = 2073,                            /* -mkl */
  OPT_mlam_ = 2074,                          /* -mlam= */
  OPT_mlarge_data_threshold_ = 2075,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 2076,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 2077,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 2078,                /* -mlong-double-80 */
  OPT_mlwp = 2079,                           /* -mlwp */
  OPT_mlzcnt = 2080,                         /* -mlzcnt */
  OPT_mmanual_endbr = 2081,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 2082,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 2083,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 2084,                  /* -mmitigate-rop */
  OPT_mmmx = 2085,                           /* -mmmx */
  OPT_mmovbe = 2086,                         /* -mmovbe */
  OPT_mmovdir64b = 2087,                     /* -mmovdir64b */
  OPT_mmovdiri = 2088,                       /* -mmovdiri */
  OPT_mmove_max_ = 2089,                     /* -mmove-max= */
  OPT_mmpx = 2090,                           /* -mmpx */
  OPT_mms_bitfields = 2091,                  /* -mms-bitfields */
  OPT_mmusl = 2092,                          /* -mmusl */
  OPT_mmwait = 2093,                         /* -mmwait */
  OPT_mmwaitx = 2094,                        /* -mmwaitx */
  OPT_mneeded = 2095,                        /* -mneeded */
  OPT_mno_align_stringops = 2096,            /* -mno-align-stringops */
  OPT_mno_default = 2097,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 2098,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 2099,                  /* -mno-push-args */
  OPT_mno_red_zone = 2100,                   /* -mno-red-zone */
  OPT_mno_sse4 = 2101,                       /* -mno-sse4 */
  OPT_mnop_mcount = 2102,                    /* -mnop-mcount */
  OPT_mnoreturn_no_callee_saved_registers = 2103,/* -mnoreturn-no-callee-saved-registers */
  OPT_momit_leaf_frame_pointer = 2104,       /* -momit-leaf-frame-pointer */
  OPT_mpartial_vector_fp_math = 2105,        /* -mpartial-vector-fp-math */
  OPT_mpc32 = 2106,                          /* -mpc32 */
  OPT_mpc64 = 2107,                          /* -mpc64 */
  OPT_mpc80 = 2108,                          /* -mpc80 */
  OPT_mpclmul = 2109,                        /* -mpclmul */
  OPT_mpcommit = 2110,                       /* -mpcommit */
  OPT_mpconfig = 2111,                       /* -mpconfig */
  OPT_mpku = 2112,                           /* -mpku */
  OPT_mpopcnt = 2113,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 2114, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 2115,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 2116,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchi = 2117,                     /* -mprefetchi */
  OPT_mprefetchwt1 = 2118,                   /* -mprefetchwt1 */
  OPT_mprfchw = 2119,                        /* -mprfchw */
  OPT_mptwrite = 2120,                       /* -mptwrite */
  OPT_mpush_args = 2121,                     /* -mpush-args */
  OPT_mraoint = 2122,                        /* -mraoint */
  OPT_mrdpid = 2123,                         /* -mrdpid */
  OPT_mrdrnd = 2124,                         /* -mrdrnd */
  OPT_mrdseed = 2125,                        /* -mrdseed */
  OPT_mrecip = 2126,                         /* -mrecip */
  OPT_mrecip_ = 2127,                        /* -mrecip= */
  OPT_mrecord_mcount = 2128,                 /* -mrecord-mcount */
  OPT_mrecord_return = 2129,                 /* -mrecord-return */
  OPT_mred_zone = 2130,                      /* -mred-zone */
  OPT_mregparm_ = 2131,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 2132,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 2133,                           /* -mrtd */
  OPT_mrtm = 2134,                           /* -mrtm */
  OPT_msahf = 2135,                          /* -msahf */
  /* OPT_mscatter = 2136, */                 /* -mscatter */
  OPT_mserialize = 2137,                     /* -mserialize */
  OPT_msgx = 2138,                           /* -msgx */
  OPT_msha = 2139,                           /* -msha */
  OPT_msha512 = 2140,                        /* -msha512 */
  OPT_mshstk = 2141,                         /* -mshstk */
  OPT_mskip_rax_setup = 2142,                /* -mskip-rax-setup */
  OPT_msm3 = 2143,                           /* -msm3 */
  OPT_msm4 = 2144,                           /* -msm4 */
  OPT_msoft_float = 2145,                    /* -msoft-float */
  OPT_msse = 2146,                           /* -msse */
  OPT_msse2 = 2147,                          /* -msse2 */
  OPT_msse2avx = 2148,                       /* -msse2avx */
  OPT_msse3 = 2149,                          /* -msse3 */
  OPT_msse4 = 2150,                          /* -msse4 */
  OPT_msse4_1 = 2151,                        /* -msse4.1 */
  OPT_msse4_2 = 2152,                        /* -msse4.2 */
  OPT_msse4a = 2153,                         /* -msse4a */
  /* OPT_msse5 = 2154, */                    /* -msse5 */
  OPT_msseregparm = 2155,                    /* -msseregparm */
  OPT_mssse3 = 2156,                         /* -mssse3 */
  OPT_mstack_arg_probe = 2157,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 2158, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2159,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 2160, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 2161,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 2162,                  /* -mstackrealign */
  OPT_mstore_max_ = 2163,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 2164,            /* -mstringop-strategy= */
  OPT_mstv = 2165,                           /* -mstv */
  OPT_mtbm = 2166,                           /* -mtbm */
  OPT_mtls_dialect_ = 2167,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 2168,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 2169,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 2170,                    /* -mtune-ctrl= */
  OPT_mtune_ = 2171,                         /* -mtune= */
  OPT_muclibc = 2172,                        /* -muclibc */
  OPT_muintr = 2173,                         /* -muintr */
  OPT_munroll_only_small_loops = 2174,       /* -munroll-only-small-loops */
  OPT_musermsr = 2175,                       /* -musermsr */
  OPT_mvaes = 2176,                          /* -mvaes */
  OPT_mveclibabi_ = 2177,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 2178,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 2179,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 2180,                    /* -mvzeroupper */
  OPT_mwaitpkg = 2181,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 2182,                      /* -mwbnoinvd */
  OPT_mwidekl = 2183,                        /* -mwidekl */
  OPT_mx32 = 2184,                           /* -mx32 */
  OPT_mxop = 2185,                           /* -mxop */
  OPT_mxsave = 2186,                         /* -mxsave */
  OPT_mxsavec = 2187,                        /* -mxsavec */
  OPT_mxsaveopt = 2188,                      /* -mxsaveopt */
  OPT_mxsaves = 2189,                        /* -mxsaves */
  OPT_n = 2190,                              /* -n */
  OPT_name_sort = 2191,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2192,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2193,              /* -no-integrated-cpp */
  OPT_no_pie = 2194,                         /* -no-pie */
  OPT_nocpp = 2195,                          /* -nocpp */
  OPT_nodefaultlibs = 2196,                  /* -nodefaultlibs */
  OPT_nolibc = 2197,                         /* -nolibc */
  OPT_nophoboslib = 2198,                    /* -nophoboslib */
  OPT_nostartfiles = 2199,                   /* -nostartfiles */
  OPT_nostdinc = 2200,                       /* -nostdinc */
  OPT_nostdinc__ = 2201,                     /* -nostdinc++ */
  OPT_nostdlib = 2202,                       /* -nostdlib */
  OPT_nostdlib__ = 2203,                     /* -nostdlib++ */
  OPT_o = 2204,                              /* -o */
  OPT_objects = 2205,                        /* -objects */
  OPT_p = 2206,                              /* -p */
  OPT_pass_exit_codes = 2207,                /* -pass-exit-codes */
  /* OPT_pedantic = 2208, */                 /* -pedantic */
  OPT_pedantic_errors = 2209,                /* -pedantic-errors */
  OPT_pg = 2210,                             /* -pg */
  OPT_pie = 2211,                            /* -pie */
  OPT_pipe = 2212,                           /* -pipe */
  OPT_posix = 2213,                          /* -posix */
  OPT_print_file_name_ = 2214,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2215,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2216,          /* -print-multi-directory */
  OPT_print_multi_lib = 2217,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2218,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2219,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2220,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2221,               /* -print-prog-name= */
  OPT_print_search_dirs = 2222,              /* -print-search-dirs */
  OPT_print_sysroot = 2223,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2224,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2225,                    /* -print-value */
  OPT_profile = 2226,                        /* -profile */
  OPT_pthread = 2227,                        /* -pthread */
  OPT_quiet = 2228,                          /* -quiet */
  OPT_r = 2229,                              /* -r */
  OPT_rdynamic = 2230,                       /* -rdynamic */
  OPT_remap = 2231,                          /* -remap */
  OPT_reverse_sort = 2232,                   /* -reverse-sort */
  OPT_s = 2233,                              /* -s */
  OPT_save_temps = 2234,                     /* -save-temps */
  OPT_save_temps_ = 2235,                    /* -save-temps= */
  OPT_shared = 2236,                         /* -shared */
  OPT_shared_libgcc = 2237,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2238,               /* -shared-libphobos */
  OPT_size_sort = 2239,                      /* -size-sort */
  /* OPT_specs = 2240, */                    /* -specs */
  OPT_specs_ = 2241,                         /* -specs= */
  OPT_static = 2242,                         /* -static */
  OPT_static_libasan = 2243,                 /* -static-libasan */
  OPT_static_libgcc = 2244,                  /* -static-libgcc */
  OPT_static_libgfortran = 2245,             /* -static-libgfortran */
  OPT_static_libgm2 = 2246,                  /* -static-libgm2 */
  OPT_static_libgo = 2247,                   /* -static-libgo */
  OPT_static_libhwasan = 2248,               /* -static-libhwasan */
  OPT_static_liblsan = 2249,                 /* -static-liblsan */
  OPT_static_libmpx = 2250,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2251,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2252,               /* -static-libphobos */
  OPT_static_libquadmath = 2253,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2254,               /* -static-libstdc++ */
  OPT_static_libtsan = 2255,                 /* -static-libtsan */
  OPT_static_libubsan = 2256,                /* -static-libubsan */
  OPT_static_pie = 2257,                     /* -static-pie */
  /* OPT_std_c__03 = 2258, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2259, */                /* -std=c++0x */
  OPT_std_c__11 = 2260,                      /* -std=c++11 */
  OPT_std_c__14 = 2261,                      /* -std=c++14 */
  OPT_std_c__17 = 2262,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2263, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2264, */                /* -std=c++1z */
  OPT_std_c__20 = 2265,                      /* -std=c++20 */
  OPT_std_c__23 = 2266,                      /* -std=c++23 */
  OPT_std_c__26 = 2267,                      /* -std=c++26 */
  /* OPT_std_c__2a = 2268, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2269, */                /* -std=c++2b */
  /* OPT_std_c__2c = 2270, */                /* -std=c++2c */
  OPT_std_c__98 = 2271,                      /* -std=c++98 */
  OPT_std_c11 = 2272,                        /* -std=c11 */
  OPT_std_c17 = 2273,                        /* -std=c17 */
  /* OPT_std_c18 = 2274, */                  /* -std=c18 */
  /* OPT_std_c1x = 2275, */                  /* -std=c1x */
  OPT_std_c23 = 2276,                        /* -std=c23 */
  /* OPT_std_c2x = 2277, */                  /* -std=c2x */
  /* OPT_std_c89 = 2278, */                  /* -std=c89 */
  OPT_std_c90 = 2279,                        /* -std=c90 */
  OPT_std_c99 = 2280,                        /* -std=c99 */
  /* OPT_std_c9x = 2281, */                  /* -std=c9x */
  OPT_std_f2003 = 2282,                      /* -std=f2003 */
  OPT_std_f2008 = 2283,                      /* -std=f2008 */
  OPT_std_f2008ts = 2284,                    /* -std=f2008ts */
  OPT_std_f2018 = 2285,                      /* -std=f2018 */
  OPT_std_f2023 = 2286,                      /* -std=f2023 */
  OPT_std_f95 = 2287,                        /* -std=f95 */
  OPT_std_gnu = 2288,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2289, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2290, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2291,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2292,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2293,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2294, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2295, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2296,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2297,                    /* -std=gnu++23 */
  OPT_std_gnu__26 = 2298,                    /* -std=gnu++26 */
  /* OPT_std_gnu__2a = 2299, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2300, */              /* -std=gnu++2b */
  /* OPT_std_gnu__2c = 2301, */              /* -std=gnu++2c */
  OPT_std_gnu__98 = 2302,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2303,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2304,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2305, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2306, */                /* -std=gnu1x */
  OPT_std_gnu23 = 2307,                      /* -std=gnu23 */
  /* OPT_std_gnu2x = 2308, */                /* -std=gnu2x */
  /* OPT_std_gnu89 = 2309, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2310,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2311,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2312, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2313, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2314,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2315, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2316, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2317, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2318, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2319, */         /* -std=iso9899:2018 */
  /* OPT_std_iso9899_2024 = 2320, */         /* -std=iso9899:2024 */
  OPT_std_legacy = 2321,                     /* -std=legacy */
  OPT_stdlib_ = 2322,                        /* -stdlib= */
  OPT_symbol_ = 2323,                        /* -symbol= */
  OPT_symbolic = 2324,                       /* -symbolic */
  OPT_t = 2325,                              /* -t */
  OPT_time = 2326,                           /* -time */
  OPT_time_ = 2327,                          /* -time= */
  OPT_tno_android_cc = 2328,                 /* -tno-android-cc */
  OPT_tno_android_ld = 2329,                 /* -tno-android-ld */
  OPT_traditional = 2330,                    /* -traditional */
  OPT_traditional_cpp = 2331,                /* -traditional-cpp */
  OPT_tree_stats = 2332,                     /* -tree-stats */
  OPT_trigraphs = 2333,                      /* -trigraphs */
  OPT_type_stats = 2334,                     /* -type-stats */
  OPT_u = 2335,                              /* -u */
  OPT_undef = 2336,                          /* -undef */
  OPT_v = 2337,                              /* -v */
  OPT_version = 2338,                        /* -version */
  OPT_w = 2339,                              /* -w */
  OPT_wrapper = 2340,                        /* -wrapper */
  OPT_x = 2341,                              /* -x */
  OPT_z = 2342,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
